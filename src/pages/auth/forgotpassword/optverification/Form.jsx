    ...
    <MainComponent>
      <Container maxWidth="sm">
        <Box className="displayColumn">
          ...
          <Typography variant="title2">{t("otp_verification")}</Typography>
        </Box>
        <Typography variant="h6" color="#8f8787" textAlign="center">
          {t("otp_verification_description", { email: email || "your email" })}
        </Typography>
        <form onSubmit={handleSubmit} alignContent="center">
          ...
          >
            ...
            <Box mt={2} className="myTimer">
              ...
              >
                {resendLoading ? t("resending") : t("resend_otp")}
              </Typography>
            </Box>
          </Box>
