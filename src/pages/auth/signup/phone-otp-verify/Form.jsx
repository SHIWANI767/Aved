...
export default function Form() {
  ...
  const { phoneNumber, mobileNumber } = router.query;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(res.data.responseCode === 200){
        ...
        if(res?.data?.responseMessage === "Mobile number already verified."){
    ...
    <MainComponent >
      <Container maxWidth="sm">
        ...
        <Typography variant="h6" color="#8f8787" textAlign='center'>
          Check your <strong>{phoneNumber || "your phone number"}</strong> for the
          verification code.
        </Typography>
