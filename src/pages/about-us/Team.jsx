  ...
  return (
        <Container className="main-sectionGap">
           ...
           <Box align="center" className="subSection">
            <Typography variant="h2"  style={{ textTransform: "uppercase" }}>Members of the Board of Directors</Typography></Box>
    <div style={{ display: "flex", gap: "30px", flexWrap: "wrap" }} className="teamGridBox">
