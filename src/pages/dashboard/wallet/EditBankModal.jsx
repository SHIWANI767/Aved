...
export default function EditAddBankModal({ open, onClose, data }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      branchName: Yup.string().required(t("errors.branch")),
  ...
  return (
    ...
    >
      <DialogTitle>
        <Typography variant="h4">{t("editBank.title")}</Typography>
      </DialogTitle>
